...
let spriteSheetFilenames = ["SpelunkyMonk.png", "SpelunkyPurple.png"];
let spriteSheets = [];
...
function setup() {
  ...
  for(let i=0; i < totalAnimations; i++) {
    animations[i] = new WalkingAnimation(random(spriteSheets),80,80,random(100,300),random(100,300),9);
  }
}
